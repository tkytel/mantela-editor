			...
			{json.data.providers.map((val, idx) => {
				return (
					<div className="block p-6 bg-white border border-gray-200 rounded-lg shadow-sm mb-3 relative" key={idx}>
						...
						{/* 名前 */}
						<div className="mb-5">
							<label htmlFor={"providers[" + idx + "].name"} className="block mb-2 text-sm font-medium text-gray-900">
						...
						{/* プレフィックス */}
						<div className="mb-5">
							<label htmlFor={"providers[" + idx + "].prefix"} className="block mb-2 text-sm font-medium text-gray-900">
						...
						<div className="flex mb-3">
							...
							<div className="ms-2 text-sm">
								<label htmlFor={"providers[" + idx + "].unavailable"} className="font-medium text-gray-900">
									利用不可
								</label>
								<p id={"providers[" + idx + "].unavailable-text"} className="text-xs font-normal text-gray-500">
