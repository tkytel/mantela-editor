	...
	return (
		<Modal
			footer={
				<>
					<button
						className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-3 focus:outline-hidden focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
					...
					<button
						className="bg-white hover:bg-gray-100 focus:ring-3 focus:outline-hidden focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100 dark:hover:bg-gray-700 dark:hover:text-gray-100 dark:focus:ring-blue-800"
						onClick={handleClose}
						type="button"
					>
						キャンセル
