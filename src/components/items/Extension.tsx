...
export default function Extension({ extension, idx }: { extension: MantelaExtension; idx: number }) {
	...
	const handleTypeChange = (selected: SingleValue<(typeof ExtensionTypeOptions)[number]>) => {
		setJson((draft) => {
	...
	return (
		<div className="block p-6 bg-white border border-gray-200 rounded-lg shadow-sm mb-3 relative" key={idx}>
			{/* 削除 ボタン */}
			<button
				type="button"
			...
			{/* 名前 */}
			<div className="mb-5">
				<label htmlFor={"extensions[" + idx + "].name"} className="block mb-2 text-sm font-medium text-gray-900">
			...
			{/* モデル */}
			<div className="mb-5">
				<label htmlFor={"extensions[" + idx + "].model"} className="block mb-2 text-sm font-medium text-gray-900">
					端末のモデル・型式名
				</label>
				<div className="relative w-full">
					<input
						...
						onChange={(e) => {
							setJson((draft) => {
								draft.data.extensions[idx].model = e.target.value;
							});
						}}
			...
			{/* 番号 */}
			<div className="mb-5">
				<label htmlFor={"extensions[" + idx + "].extension"} className="block mb-2 text-sm font-medium text-gray-900">
			...
			{/* 種別 */}
			<div className="mb-5">
				<label htmlFor={"extensions[" + idx + "].type"} className="block mb-2 text-sm font-medium text-gray-900">
			...
			{/* 識別子 */}
			<div className="mb-5">
				<label htmlFor={"extensions[" + idx + "].identifier"} className="block mb-2 text-sm font-medium text-gray-900">
					識別子
				</label>
				<div className="relative w-full">
					<input
			...
			<div className="flex mb-3">
				...
				<div className="ms-2 text-sm">
					<label htmlFor={`helper-checkbox-extension${idx}`} className="font-medium text-gray-900">
						設置場所を指定する
					</label>
			...
			{/* 画像 */}
			<div className="mb-5">
				<label htmlFor={"extensions[" + idx + "].image"} className="block mb-2 text-sm font-medium text-gray-900">
					端末に関連する画像の URL
				</label>
				<div className="relative w-full">
					<input
